        ...
        for distance_of_car, vehicle in sorted_vehicles:
            ...
            for distance_in_meter in final_vehicle_result:
                if distance_in_meter['distance'] > 10 and distance_in_meter['distance'] < 15:
                    ...
                    time.sleep(3)
                    dropped_vehicle.apply_control(carla.VehicleControl(throttle=0.2,steering=-0.2))
                    time.sleep(2)
                    dropped_vehicle.apply_control(carla.VehicleControl(throttle=0.2,steering=0.1))
                    time.sleep(2)
                    dropped_vehicle.apply_control(carla.VehicleControl(throttle=0.2))
                    time.sleep(3)
                    print("close car name : ", distance_in_meter['vehicle_name'])
